...
namespace WebMyBookStoreApi.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public BooksController(MyBookStoreDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Book>> PostBook(Book book)
        {
          if (_context.Books == null)
          {
              return Problem("Entity set 'MyBookStoreDbContext.Books'  is null.");
          }
